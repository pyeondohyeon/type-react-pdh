...
(function () {
    ...
    function P(g) {
        var l = ((g & 16711680) >> 16).toString(16), v = ((g & 65280) >> 8).toString(16);
    ...
    function N(g, l) {
        ...
        }[g || "solid"]) for (var s = 0; s < v.length; s++) v[s] *= l; else v = [];
        return v
    }
    ...
    function gb(g) {
        ...
        }), Ka(g._menuButton), g._menuButton.title = g._cultureInfo.menuText) : ua(g._menuButton); else if (g.exportEnabled && w) {
            var l = !1;
    ...
    function Ya(g, l, v) {
        ...
        l = !0;
        for (v = 0; 4 > v; v++) if (g[v] !== g[v + 4] | g[v] !== g[v + 8] |
            g[v] !== g[v + 12]) {
            l = !1;
            break
        }
    ...
    var Ga = !1, S = {}, w = !!document.createElement("canvas").getContext, pa = {
            Chart: {
                width: 500,
                height: 400,
                zoomEnabled: !1,
        ...
        Ja = {en: {}}, y = w ? "Trebuchet MS, Helvetica, sans-serif" : "Arial",
        Ea = w ? "Impact, Charcoal, sans-serif" : "Arial", za = {
    ...
    (function () {
        ...
        S._fTWm = function (g) {
            if ("undefined" === typeof S.pro.sCH && !bb) try {
                var l =
                    (new Date).getMonth() % 3, v, s, w = g[S.fSDec("buy")];
    ...
    var fb = function () {
            ...
            return function (F, N, M) {
                var H = M ? M.days : l, P = M ? M.months : s, J = M ? M.shortDays : v, R = M ? M.shortMonths : w;
                M = "";
                var S = !1;
            ...
            var s = 0 > g ? !0 : !1;
            s && (g *= -1);
            var w = v ? v.decimalSeparator : ".", y = v ? v.digitGroupSeparator : ",", E = "";
            l = String(l);
            var E = 1, F = v = "", N = -1, M = [], H = [], P = 0, J = 0, R = 0, S = !1, U = 0,
                F = l.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            l = null;
            for (var K = 0; F && K < F.length; K++) if (l = F[K], "." === l && 0 > N) N = K; else {
            ...
            g = (l[1] + "").split("");
            E && "0" === E[0] && E.shift();
            for (S = F = K = J = N = 0; 0 < M.length;) if (l = M.pop(), "#" === l || "0" ===
            l) if (N++, N === P) {
                var V = E, E = [];
                if ("0" === l) for (l = P - J - (V ? V.length : 0); 0 < l;) V.unshift("0"), l--;
                for (; 0 < V.length;) v = V.pop() + v, S++, 0 === S % F && (K === R && 0 < V.length) && (v = y + v)
            } else 0 < E.length ? (v = E.pop() + v, J++, S++) : "0" === l && (v = "0" + v, J++, S++), 0 === S % F && (K === R && 0 < E.length) && (v = y + v); else "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? "," === l ? (K++, F = S, S = 0, 0 < E.length && (v = y + v)) : v = 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? l.slice(1, l.length - 1) + v : l + v : (l = 0 > U ? l.replace("+",
        ...
        ib = bb && -1 === window[ga("mnb`uhno")].href.indexOf(ga("gheemd")), jb = {
    ...
    U.prototype.set = function (g, l, s) {
        ...
        if ("options" === g) this.createUserOptions(l); else if (w.hasOwnProperty(g) || w.publicProperties && w.publicProperties.hasOwnProperty(g) && "readWrite" === w.publicProperties[g]) this.options._isPlaceholder && this.createUserOptions(), this.options[g] = l; else {
    ...
    U.prototype.addTo = function (g, l, s, w) {
        ...
        y.hasOwnProperty(g) || y.publicProperties && y.publicProperties.hasOwnProperty(g) && "readWrite" === y.publicProperties[g] ? (this.options._isPlaceholder && this.createUserOptions(), "undefined" === typeof this.options[g] && (this.options[g] =
    ...
    U.prototype.updateOption = function (g) {
        ...
        var l = pa[this._defaultsKey], w = {}, y = this[g], F = this._themeOptionsKey,
            J = this._index;
    ...
    U.prototype.removeEventListener = function (g, l) {
        if (g && l && this._eventListeners[g]) for (var s = this._eventListeners[g], w = 0; w < s.length; w++) if (s[w].eventHandler === l) {
            s[w].splice(w, 1);
            break
        }
    };
    ...
    ia.prototype.render = function (g) {
        if (0 !== this.fontSize) {
            ...
            var w = 0, y = this.topPadding, F = null;
            ...
            for (s = 0; s < this._wrappedText.lines.length; s++) {
                ...
                if ("right" === this.horizontalAlign || "right" === this.textAlign) w = this.width - F.width - this.rightPadding; else if ("left" === this.horizontalAlign || "left" === this.textAlign) w = this.leftPadding; else if ("center" === this.horizontalAlign || "center" === this.textAlign) w = (this.width - (this.leftPadding + this.rightPadding)) / 2 - F.width / 2 + this.leftPadding;
    ...
    ia.prototype._getLineWithWidth = function (g, l, s) {
        ...
        var w = s = 0, y = g.length - 1, F = Infinity;
        for (this.ctx.font = this._getFontString(); w <= y;) {
            var F = Math.floor((w + y) / 2), E = g.substr(0, F + 1);
    ...
    ia.prototype._wrapText = function () {
        var g = new String(Fa(String(this.text))), l = [], s = this.ctx.font, w = 0, y = 0;
        this.ctx.font = this._getFontString();
        if (0 === this.frontSize) y = w = 0; else for (; 0 < g.length;) {
            ...
            l.push(E);
            var J = y, y = Math.max(y, E.width), w = w + E.height, g = Fa(g.slice(E.text.length, g.length));
    ...
    ya.prototype.setLayout = function () {
        if (this.text) {
            var g = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, l = g.layoutManager.getFreeSpace(),
                w = l.x1, y = l.y1, F = 0, J = 0,
                E = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, N, H;
    ...
    y = Oa.Chart = function () {
        ...
        l.prototype.categoriseDataSeries = function () {
            for (var a = "", d = 0; d < this.data.length; d++) if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= l._supportedChartTypes.indexOf(a.type)) {
                for (var c = null, b = !1, e = null, f = !1, p = 0; p < this.plotInfo.plotTypes.length; p++) if (this.plotInfo.plotTypes[p].type === a.type) {
                    b = !0;
                ...
                for (p = 0; p <
                c.plotUnits.length; p++) if (c.plotUnits[p].axisYType === a.axisYType && c.plotUnits[p].axisXType === a.axisXType && c.plotUnits[p].axisYIndex === a.axisYIndex && c.plotUnits[p].axisXIndex === a.axisXIndex) {
                    f = !0;
                    e = c.plotUnits[p];
                    break
                }
        ...
        l.prototype._processMultiseriesPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                var t = this.data[a.dataSeriesIndexes[p]], B = 0, k = !1, m = !1, n;
                ...
                for (B = 0; B < t.dataPoints.length; B++) {
                    ...
                    if (b < q && !k) null !== e && (n = b); else {
                        ...
                        if (b > h && !m) m = !0; else if (b > h && m) continue;
        ...
        l.prototype._processStackedPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = [], t = [], B = Infinity, k = -Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var n =
                        this.data[a.dataSeriesIndexes[m]], q = 0, h = !1, r = !1, g;
        ...
        l.prototype._processStacked100PlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = !1, t = !1, B = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var m = this.data[a.dataSeriesIndexes[k]], n = 0, q = !1, h = !1, r;
        ...
        l.prototype._processMultiYPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e,
                ...
                var k = this.data[a.dataSeriesIndexes[B]], m = 0, n = !1, q = !1, h, r, g;
        ...
        l.prototype._processSpecificPlotUnit = function (a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                var t = this.data[a.dataSeriesIndexes[p]], B = 0, k = !1, m = !1, n = b = 0;
                ...
                for (B = 0; B < t.dataPoints.length; B++) if ("undefined" === typeof t.dataPoints[B].x && (t.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0)),
        ...
        l.prototype.calculateAutoBreaks = function () {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b ||
                        ...
                        if (!(4 > g.dataPoints.length)) for (t = 0; t < g.dataPoints.length; t++) if (b && (q = (p + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, h = g.dataPoints[t].x.getTime ? g.dataPoints[t].x.getTime() : g.dataPoints[t].x, q = Math.floor((h - k) / q), h < f[q].min && (f[q].min = h), h > f[q].max && (f[q].max = h)), c) {
                            var l =
                                (n + 1 - m) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
                            if ((h = "waterfall" === a.type ? g.dataPointEOs[t].cumulativeSum : g.dataPoints[t].y) && h.length) for (var w = 0; w < h.length; w++) q = Math.floor((h[w] - m) / l), h[w] < d[q].min && (d[q].min = h[w]), h[w] > d[q].max && (d[q].max = h[w]); else s(h) || (q = Math.floor((h - m) / l), h < d[q].min && (d[q].min = h), h > d[q].max && (d[q].max = h))
                        }
                    }
                }
            }
            ...
            function c(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <=
                    a.axisX.scaleBreaks.maxNumberOfAutoBreaks) for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, h, k = 0, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var m = e.data[a.dataSeriesIndexes[p]];
                    if (!(4 > m.dataPoints.length)) for (k = 0; k < m.dataPoints.length; k++) h = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = m.dataPoints[k].x.getTime ? m.dataPoints[k].x.getTime() : m.dataPoints[k].x, h = Math.floor((b - c) / h), b < f[h].min && (f[h].min = b), b > f[h].max && (f[h].max = b)
                }
            }

            for (var b, e = this, f = !1, p = 0; p <
            this._axes.length; p++) if (this._axes[p].scaleBreaks && this._axes[p].scaleBreaks.autoCalculate && 1 <= this._axes[p].scaleBreaks.maxNumberOfAutoBreaks) {
                f = !0;
            ...
            if (f) {
                ...
                for (p = 0; p < this._axes.length; p++) if (this._axes[p].dataInfo._dataRanges) {
                    ...
                    for (t = 0; t < k.length - 1; t++) if (m = k[t].max, isFinite(m)) for (; t < k.length - 1;) if (B = k[t + 1].min, isFinite(B)) {
                        n = B - m;
                        n > b && f.push({diff: n, start: m, end: B});
                        break
                    } else t++;
                    if (this._axes[p].scaleBreaks.customBreaks) for (t = 0; t < this._axes[p].scaleBreaks.customBreaks.length; t++) for (b =
            ...
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) &&
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    if (this.panEnabled) for (e = f = 0; e < this._axes.length; e++) c = this._axes[e], c.logarithmic ? c.viewportMinimum < c.minimum ? (f = c.minimum / c.viewportMinimum, c.sessionVariables.newViewportMinimum = c.viewportMinimum * f, c.sessionVariables.newViewportMaximum =
                        ...
                        f, c.sessionVariables.newViewportMaximum = c.viewportMaximum - f, p = !0); else if ((!e || 2 < Math.abs(b)) && (!f || 2 < Math.abs(c)) && this.zoomEnabled) {
        ...
        l.prototype.validateRegion = function (a, d, c, b, e) {
            ...
            for (p = 0; p < k.length; p++) {
                var n = k[p], f = !1, q = n.convertPixelToValue({x: a, y: d}), h = n.convertPixelToValue({x: c, y: b});
                if (q > h) var r = h, h = q, q = r;
                ...
                if (isFinite(n.dataInfo.minDiff)) if (r =
        ...
        l.prototype.renderIndexLabels = function (a) {
            var d = a || this.plotArea.ctx, c = this.plotArea, b = 0, e = 0, f = 0, p = f = e = 0, t = 0, B = b = 0,
                k = 0;
            for (a = 0; a < this._indexLabels.length; a++) {
                var m = this._indexLabels[a], n = m.chartType.toLowerCase(), q, h,
                    ...
                    k = la("indexLabelFontWeight", m.dataPoint,
                        m.dataSeries), g = la("indexLabelBackgroundColor", m.dataPoint, m.dataSeries);
                ...
                var l = la("indexLabelLineDashType", m.dataPoint, m.dataSeries),
                    ...
                    b = 0 < x ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ?
                        this.plotArea.height : this.plotArea.width) << 0) : 0, A = {percent: null, total: null},
                    C = null;
                ...
                if (null !== D && "" !== D) {
                    var A = la("indexLabelPlacement", m.dataPoint, m.dataSeries),
                        ...
                        z = la("indexLabelTextAlign", m.dataPoint, m.dataSeries), v = m.direction,
                        e = m.dataSeries.axisX,
                        f = m.dataSeries.axisY, y = !1, g = new ia(d, {
                            x: 0,
                            y: 0,
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        if (0 <= n.indexOf("line") || 0 <= n.indexOf("area")) A = "auto", t = 4; else if (0 <= n.indexOf("stacked")) "auto" === A && (A = "inside"); else if ("bubble" === n || "scatter" === n) A = "inside";
        ...
        l.prototype.renderLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], p, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    var B = a.dataSeriesIndexes[t], k = this.data[B];
                    ...
                    var r = k._colorSet, g = r = k.lineColor = k.options.lineColor ? k.options.lineColor : r[0];
                    c.strokeStyle = r;
                    var l = !0, u = 0, x, s;
                    c.beginPath();
                    if (0 < m.length) {
                ...
                for (var f = [], p, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (c.setLineDash) {
                        var q = N(k.nullDataLineDashType,
                            k.lineThickness), n = k.lineDashType, h = N(n, k.lineThickness);
                        c.setLineDash(h)
                    }
                    var r = k.id;
                    this._eventManager.objectMap[r] = {objectType: "dataSeries", dataSeriesIndex: B};
        ...
        l.prototype.renderSpline = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    var l = 0, u, x, s = [];
                    b.beginPath();
                    if (0 < m.length) for (x = !1, l = 0; l < m.length; l++) if (u = m[l].getTime ? m[l].x.getTime() : m[l].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !x))) if ("number" !== typeof m[l].y) 0 < l && !x && (k.connectNullData ? b.setLineDash && (0 < s.length && (k.options.nullDataLineDashType || !m[l - 1].lineDashType)) && (s[s.length -
        ...
        l.prototype.renderColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, p, t, B,
                ...
                for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var q = a.dataSeriesIndexes[m], h = this.data[q], r = h.dataPoints;
                    if (0 < r.length) for (var g = 5 < n && h.bevelEnabled ? !0 : !1, f =
                        ...
                        var l = a.axisX.reversed ? p - n << 0 : p + n << 0, u;
                        0 <= r[f].y ? u = k : (u = t, t = k);
                        t > u && (b = t, t = u, u = b);
        ...
        l.prototype.renderStackedColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = [], p = [], t = [], B = [], k = 0, m, n,
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var g =
                        a.dataSeriesIndexes[r], l = this.data[g], u = l.dataPoints;
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++) if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                            ...
                            var s = m - a.plotType.plotUnits.length * h / 2 + a.index * h << 0, C = s + h << 0, D;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] :
                                0), 0 < t[b] && (n = a.axisY.convertValueToPixel(t[b]), D = "undefined" !== typeof f[b] ? f[b] : q, f[b] = n); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = u[k].y + (B[b] ? B[b] : 0), D = a.axisY.convertValueToPixel(B[b]), n = "undefined" !== typeof p[b] ? p[b] : q, p[b] = D; else if (n = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) {
        ...
        l.prototype.renderStackedColumn100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var g =
                        a.dataSeriesIndexes[r], l = this.data[g], u = l.dataPoints;
                    if (0 < u.length) for (var x = 5 < h && l.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++) if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                        m = a.axisX.convertValueToPixel(b);
                        ...
                        if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                            ...
                            D = f[b] ? f[b] : q;
                            f[b] = n
                        } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = n + ("undefined" !== typeof B[b] ? B[b] : 0), D = a.axisY.convertValueToPixel(B[b]), n = p[b] ? p[b] : q, p[b] = D; else if (n = a.axisY.convertValueToPixel(n), 0 <= u[k].y) {
                            var z = "undefined" !== typeof f[b] ? f[b] : 0;
                            n -= z;
                            D = q - z;
        ...
        l.prototype.renderBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b =
                        null, e = this.plotArea, f = 0, p, t, B,
                    k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                ...
                for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < r.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < r.length; f++) if (r[f].getTime ? B = r[f].x.getTime() : B = r[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                            ...
                            var l = a.axisX.reversed ? t - n << 0 : t + n << 0, u;
                            0 <= r[f].y ? u = k : (u = p, p = k);
                            b = r[f].color ? r[f].color : h._colorSet[f % h._colorSet.length];
        ...
        l.prototype.renderStackedBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip());
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var g = a.dataSeriesIndexes[r], l = this.data[g], u = l.dataPoints;
                    if (0 < u.length) {
                        var x = 5 < h && l.bevelEnabled ? !0 : !1;
                        c.strokeStyle = "#4572A7 ";
                        for (k = 0; k < u.length; k++) if (b = u[k].x.getTime ? u[k].x.getTime() :
                            u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                            n = a.axisX.convertValueToPixel(b);
                            var s = n - a.plotType.plotUnits.length * h / 2 + a.index * h << 0, C = s + h << 0, D;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] : 0), 0 < t[b] && (D = f[b] ? f[b] : q, f[b] = m = a.axisY.convertValueToPixel(t[b])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = u[k].y + (B[b] ? B[b] : 0), m = p[b] ?
                                p[b] : q, p[b] = D = a.axisY.convertValueToPixel(B[b]); else if (m = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) {
                                var z = f[b] ? f[b] : 0;
                                D = q + z;
                                m += z;
                                f[b] = z + (m - D)
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < u.length) {
                        ...
                        "number" === typeof u[k].y) {
                            ...
                            var C = n - a.plotType.plotUnits.length * h / 2 + a.index * h << 0, D = C + h << 0;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                ...
                                q, p[b] = A = a.axisY.convertValueToPixel(B[b]); else if (m = a.axisY.convertValueToPixel(A), 0 <= u[k].y) {
                                var z = f[b] ? f[b] : 0;
                                A = q + z;
                                m += z;
        ...
        l.prototype.renderArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var p = this._eventManager.ghostCtx, t = a.axisY.lineCoordinates, B = [], k = this.plotArea, m;
                f.save();
                w && p.save();
                f.beginPath();
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var q = a.dataSeriesIndexes[n], h = this.data[q], r = h.dataPoints, B = h.id;
                    ...
                    d = !0;
                    var g = 0, l, u, s,
                        A = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), C, D = null;
                    if (0 < r.length) {
                        var z = h._colorSet[g % h._colorSet.length], v = h.lineColor = h.options.lineColor || z, y = v;
                        f.fillStyle = z;
                        f.strokeStyle = v;
                        ...
                        for (var ja = !0; g < r.length; g++) if (s = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(s <
        ...
        l.prototype.renderSplineArea = function (a) {
            function d() {
                ...
                if (0 < c.length) {
                    if (0 < m.lineThickness) {
                        ...
                        for (var d = 0; d < c.length - 3; d += 3) if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), w && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.stroke(),
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = this._eventManager.ghostCtx, f = a.axisY.lineCoordinates, p = [], t = this.plotArea;
                b.save();
                w && e.save();
                b.beginPath();
                b.rect(t.x1,
                ...
                for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
                    var k = a.dataSeriesIndexes[B], m = this.data[k], n = m.dataPoints, p = m.id;
                    this._eventManager.objectMap[p] = {objectType: "dataSeries", dataSeriesIndex: k};
                    p = P(p);
                    e.fillStyle = p;
                    var p = [], q = 0, h, r,
                        g = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l, u = null,
                        s = [];
                    if (0 < n.length) {
                        ...
                        var z = "solid";
                        if (b.setLineDash) {
                            var y = N(m.nullDataLineDashType, m.lineThickness), z = m.lineDashType,
                                E = N(z, m.lineThickness);
                            b.setLineDash(E)
                        }
                        for (r = !1; q < n.length; q++) if (h = n[q].x.getTime ? n[q].x.getTime() : n[q].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r))) if ("number" !== typeof n[q].y) 0 < q && !r && (m.connectNullData ? b.setLineDash && (0 < s.length && (m.options.nullDataLineDashType || !n[q - 1].lineDashType)) &&
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var q = a.dataSeriesIndexes[n],
                        h = this.data[q], r = h.dataPoints, B = h.id;
                    this._eventManager.objectMap[B] = {objectType: "dataSeries", dataSeriesIndex: q};
                    B = P(B);
                    p.fillStyle = B;
                    B = [];
        ...
        l.prototype.renderStackedArea = function (a) {
            ...
            var c =
                a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, p = [], t = this.plotArea, g = [], k = [], m = [], n = [], q = 0, h, r,
                    l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    s = this._eventManager.ghostCtx, u, x, A;
                w && s.beginPath();
                b.save();
                w && s.save();
                b.beginPath();
        ...
        l.prototype.renderStackedArea100 = function (a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, p = this.plotArea, t = [], g = [], k = [], m = [], n = [], q = 0, h, r, l, s, u,
                ...
                for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
                    var v = a.dataSeriesIndexes[C], z = this.data[v], y = z.dataPoints;
                    z.dataPointIndexes = [];
                ...
                for (C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    if (0 < m.length) {
                        var e = z._colorSet[q %
                        z._colorSet.length], E = z.lineColor = z.options.lineColor || e, Q = E;
                        b.fillStyle = e;
                        b.strokeStyle = E;
        ...
        l.prototype.renderBubble = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var t = -Infinity, g = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++) for (var m = a.dataSeriesIndexes[k], n = this.data[m], q = n.dataPoints,
        ...
        l.prototype.renderScatter = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    var g = a.dataSeriesIndexes[t], k = this.data[g], m = k.dataPoints;
                    if (0 < m.length) {
                        c.strokeStyle = "#4572A7 ";
        ...
        l.prototype.renderCandlestick = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, p = this.plotArea, t = 0, g, k, m, n, q, h,
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var v = a.dataSeriesIndexes[l], u = this.data[v], x = u.dataPoints;
                    if (0 < x.length) for (var A = 5 < r && u.bevelEnabled ? !0 : !1, t = 0; t < x.length; t++) if (x[t].getTime ? h = x[t].x.getTime() : h = x[t].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(x[t].y) && x[t].y.length && "number" === typeof x[t].y[0] &&
                    "number" === typeof x[t].y[1] && "number" === typeof x[t].y[2] && "number" === typeof x[t].y[3]) {
                        ...
                        var C = g - r / 2 << 0, D = C + r << 0,
                            f = u.options.fallingColor ? u.fallingColor : u._colorSet[0],
                            e = x[t].color ? x[t].color : u._colorSet[0], z = Math.round(Math.max(1, 0.15 * r)),
                            y = 0 === z % 2 ? 0 : 0.5, E = u.dataPointIds[t];
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = !1, l = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < A.length) for (var C = 5 < r && x.bevelEnabled ? !0 : !1, p = 0; p < A.length; p++) if (A[p].getTime ? h = A[p].x.getTime() : h = A[p].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(A[p].y) && A[p].y.length && "number" === typeof A[p].y[0] && "number" === typeof A[p].y[1] && "number" === typeof A[p].y[2] && "number" === typeof A[p].y[3] && "number" === typeof A[p].y[4] && 5 === A[p].y.length) {
                        ...
                        var D = t - r / 2 << 0, z = t + r / 2 << 0, e = A[p].color ? A[p].color : x._colorSet[0],
                            y = Math.round(Math.max(1, 0.15 * r)), E = 0 === y % 2 ? 0 : 0.5,
                            ...
                            G = 1 === Math.round(ba) % 2 ? 0.5 : 0, J = A[p].stemDashType ? A[p].stemDashType :
                            x.stemDashType,
                            ...
                            sa = s(x.options.fillOpacity) ? 1 : x.fillOpacity, O = x.dataPointIds[p];
        ...
        l.prototype.renderRangeColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, p, t, g,
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var n = a.dataSeriesIndexes[m], q = this.data[n], h = q.dataPoints;
                    if (0 < h.length) for (var r =
                        ...
                        var l = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + m) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount +
                            m) * k << 0, v = a.axisX.reversed ? l - k << 0 : l + k << 0,
        ...
        l.prototype.renderError =
            function (a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var e = null, f = !1, p = this.plotArea, t = 0, g, k, m, n, q, h, r, l = a.axisX.dataInfo.minDiff;
                    ...
                    for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                        var A = a.dataSeriesIndexes[x], C = this.data[A], D = C.dataPoints,
                            z = s(C._linkedSeries) ? !1 : C._linkedSeries.type.match(/(bar|column)/ig) && C._linkedSeries.visible ? !0 : !1,
                            E = 0;
                        if (z) for (e = C._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/ig) ||
                        ...
                        (u = e);
                        u > t && (u = t);
                        if (0 < D.length) for (var F = C._colorSet, t = 0; t < D.length; t++) {
        ...
        l.prototype.renderRangeBar = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx :
                d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, p, t, g, k,
                    f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var q = a.dataSeriesIndexes[n], h = this.data[q], r = h.dataPoints;
                    if (0 < r.length) {
        ...
        l.prototype.renderRangeArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    var g = [], k = a.dataSeriesIndexes[t], m = this.data[k], n = m.dataPoints, f = m.id;
                    this._eventManager.objectMap[f] = {objectType: "dataSeries", dataSeriesIndex: k};
                    f = P(f);
                    e.fillStyle = f;
                    var f = [], q = !0, h = 0, r, l, s, u, x = null;
                    if (0 < n.length) {
                        var v = m._colorSet[h % m._colorSet.length], C = m.lineColor = m.options.lineColor || v, D = C;
                        b.fillStyle = v;
                        b.strokeStyle = C;
                        b.lineWidth = m.lineThickness;
                        var z = "solid";
                        ...
                        for (var Q = !0; h < n.length; h++) if (u = n[h].x.getTime ? n[h].x.getTime() : n[h].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !Q))) if (null !== n[h].y && n[h].y.length && "number" === typeof n[h].y[0] && "number" === typeof n[h].y[1]) {
                            ...
                            q || Q ? (m.connectNullData && !q ? (b.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType &&
                                ...
                                y1: l,
                                y2: s
                            })) : (b.beginPath(), b.moveTo(r, l), x = {x: r, y: l}, g = [], g.push({
                                x: r,
                                y1: l,
                                y2: s
        ...
        l.prototype.renderRangeSplineArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                w && (e.beginPath(), e.rect(p.x1, p.y1, p.width, p.height), e.clip());
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    var g = a.dataSeriesIndexes[t], k = this.data[g], m = k.dataPoints, f = k.id;
                    this._eventManager.objectMap[f] =
                    ...
                    var f = [], n = 0, q, h, r, l = [], s = [];
                    if (0 < m.length) {
                        var u = k._colorSet[n % k._colorSet.length], x = k.lineColor = k.options.lineColor || u, A = x;
                        b.fillStyle = u;
                        b.lineWidth = k.lineThickness;
                        var C = "solid", D;
                        if (b.setLineDash) {
                            var z = N(k.nullDataLineDashType, k.lineThickness), C = k.lineDashType;
                            D = N(C, k.lineThickness)
                        }
                        for (h = !1; n < m.length; n++) if (q = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
        ...
        l.prototype.renderWaterfall = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, p = 0, t, g, k, m,
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    if (0 < v.length) for (var A = 5 < q && s.bevelEnabled ? !0 : !1, C = !1, D = null, z = null, p = 0; p < v.length; p++) if (v[p].getTime ?
        ...
        l.prototype.renderPie = function (a) {
            function d() {
                if (k && m) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
                        var f = m[e], p = k.dataPointIds[e];
                        h[e].id = p;
                        h[e].objectType = "dataPoint";
                        h[e].dataPointIndex = e;
                        h[e].dataSeriesIndex = 0;
                        var g = h[e], n = {percent: null, total: null}, t = null, n = l.getPercentAndTotal(k, f);
                        ...
                        g.indexLabelTextBlock = new ia(l.plotArea.ctx, {
                            ...
                            maxHeight: g.indexLabelWrap ? 5 * g.indexLabelFontSize :
            ...
            function c(a) {
                ...
                for (b = 0; b < m.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * z * Math.cos(h[b].midAngle), f = 0.07 * z * Math.sin(h[b].midAngle), p = !1;
                        if (m[b].exploded) {
            ...
            function e(a) {
                for (var c = null, d = 1; d < m.length; d++) if (c = (a + d + h.length) % h.length, h[c].hemisphere !== h[a].hemisphere) {
                    c = null;
                    break
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < m.length) {
                    ...
                    p = null;
                    for (g = 1; g < m.length; g++) if (p = (a - g + h.length) % h.length, h[p].hemisphere !== h[a].hemisphere) {
                        p = null;
                        break
            ...
            function p() {
                ...
                for (var c = a = 0, d = 0, p = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    ...
                    } else for (a = 0; a < m.length; a++) g = h[a], w = "pie" === k.type ? 0.7 * z : 0.8 * z, s = A.x + w * Math.cos(g.midAngle), u = A.y + w * Math.sin(g.midAngle), g.indexLabelTextBlock.x = s, g.indexLabelTextBlock.y = u;
                    for (a = 0; a < m.length; a++) if (g = h[a], s = g.indexLabelTextBlock.measureText(), 0 !== s.height && 0 !== s.width) s = s = 0, "right" === g.hemisphere ? (s = q.x2 - (g.indexLabelTextBlock.x + g.indexLabelTextBlock.width +
                            ...
                            if (null !== p) {
                                ...
                                if (q = 0 > C) {
                                    ...
                                    var l = t.indexLabelTextBlock.y - t.indexLabelTextBlock.height /
                                        2, r = t.indexLabelTextBlock.y + t.indexLabelTextBlock.height / 2,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k =
                        this.data[a.dataSeriesIndexes[0]], m = k.dataPoints, n = 10, q = this.plotArea, h = k.dataPointEOs,
                    r = 2, w, v = 1.3, u = 20 / 180 * Math.PI, x = 6, A = {x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2},
                    C = 0;
                a = !1;
        ...
        l.prototype.renderFunnel =
            function (a) {
                ...
                function e() {
                    ...
                    if (e) for (p = I.length - 1; 0 <= p; p--) a = O[p], I[p].textBlock.maxWidth = f[f.length - (p + 1)], I[p].textBlock.measureText(), I[p].textBlock.x = M - k, c = I[p].textBlock.height < I[p].textBlock.maxHeight ? I[p].textBlock.height :
                ...
                function p() {
                    ...
                    function b() {
                        ...
                        for (p = O.length - 1; 0 < p; p--) if (!I[p].isDirty) {
                            e = n(p);
                    ...
                    function c(a, b, d) {
                        ...
                        for (d = 0; d < e.length; d++) if (b = e[d], f < a) h++, f += I[b.id].height + da, I[b.id].textBlock.text = "", I[b.id].indexLabelText = "", I[b.id].isDirty = !0, I[b.id].textBlock.measureText(); else break;
                        return h
                    }
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    var H = A.x1 + D, M = A.x2 - D, Y = A.y1 + C, P = A.y2 - C,
                    ...
                    if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                        ...
                        var D = H + a / 2, W = H, Z = H + a, na = u.reversed ? P : Y, L = D - G / 2, V = D + G / 2,
                            xa = u.reversed ? Y + ba : P - ba, sa = u.reversed ? Y : P;
                        a = [];
                        var D = [], O = [], F = [], T = Y, ca, $ = (xa - na) / (L - W), ea = -$,
                        ...
                        if (-1 !== H) {
                            ...
                            if (u.reversed) for (G = 0; G < H.length; G++) F[G] < xa ? (a.push(L), D.push(V), ca = G) : (a.push((F[G] - na + $ * W) / $), D.push((F[G] - na + ea * Z) / ea)); else for (G = 0; G < H.length; G++) F[G] < xa ? (a.push((F[G] - na + $ * W) / $), D.push((F[G] - na + ea * Z) / ea), ca = G) : (a.push(L), D.push(V));
                            ...
                            if (!J) for (G = 0; G < x.length; G++) z = u.dataPointIds[G],
                                a = {
                                    id: z,
                                    objectType: "dataPoint",
                                    dataPointIndex: G,
        ...
        l.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
            ...
            if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                var p = "#percent", g = "#total", l = this.getPercentAndTotal(c, d), g = isNaN(l.total) ? g : l.total,
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
                ...
                } else return ea(h, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########", f._cultureInfo); else return "y" === a ? ea(h, d.yValueFormatString ?
        ...
        F.prototype.setLayout = function () {
            ...
            this.height = 0;
            var l = [], k = [];
            if ("top" === this.verticalAlign || "bottom" === this.verticalAlign) this.orientation = "horizontal", c = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, p = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height; else if ("center" === this.verticalAlign) {
                ...
                if (n.dataPoints && n.dataPoints.length) if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type && "pyramid" !== n.type) {
                    ...
                    var A = n.dataPoints[x],
                        ...
                        h = A.legendText ? A.legendText : n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                            ...
                            dataSeries: n,
                            dataPoint: A
                        }) : A.name ? A.name : "DataPoint: " + (x + 1), r = A.legendMarkerColor ? A.legendMarkerColor :
            ...
            for (var g = 0, l = 0; l < p.length; l++) {
                for (var k = p[l], m = 0, n = 0; n < k.items.length; n++) {
                    ...
                    if ("error" === q.chartType) {
                        ...
                        this.ctx.beginPath();
                        var w = h - 0.08 * this.lineHeight + 0.1 * this.lineHeight, u = r + 0.15 * this.lineHeight,
                            x = 0.7 * this.lineHeight, v = x + 0.02 * this.lineHeight;
                        this.ctx.moveTo(w, u);
        ...
        H.prototype.getDataPointAtX = function (a, d) {
            ...
            var c = {
                ...
                index: NaN
            }, b = null, e = 0, f = 0, p = 1, g = Infinity, l = 0, k = 0, m = 0;
        ...
        H.prototype.getDataPointAtXY = function (a, d, c) {
            ...
            c = c || !1;
            var b = [], e = 0, f = 0, p = 1, g = !1, l = Infinity, k = 0, m = 0, n = 0;
            ...
            for (; ;) {
                f = 0 < p ? n + e : n - e;
                if (0 <= f && f < this.dataPoints.length) {
                    var q = this.chart._eventManager.objectMap[this.dataPointIds[f]], h = this.dataPoints[f], r = null;
                    if (q) {
                        switch (this.type) {
                            case "column":
                            case "stackedColumn":
                            ...
                            case "splineArea":
                            case "scatter":
                                var s = la("markerSize", h, this) || 4, w = c ? 20 : s,
        ...
        E.prototype.createLabels = function () {
            var a, d, c = 0, b = 0, e, f = 0, p = 0, b = 0, b = this.interval, g = 0, l, k = 0.6 * this.chart.height, m;
            a = !1;
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval) for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, h = q; b < this.logLabelValues.length; b++) if (c =
            ...
            "top" === this._position) if (f = 0.9 * g >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                ...
                for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++) if (!this._labels[c].breaksLabelType) {
                    ...
                    if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle) if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), m = (k - (l + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI /
        ...
        E.setLayout = function (a, d, c, b, e, f) {
            var p, g, l, k, m = a[0] ? a[0].chart : d[0].chart, n = m.isNavigator ? 0 : 10, q = m._axes;
            ...
            for (h = 0; h < q.length; h++) if (q[h] && q[h].scaleBreaks &&
                q[h].scaleBreaks._appliedBreaks.length) for (var r = q[h].scaleBreaks._appliedBreaks, w = 0; w < r.length && !(r[w].startValue > q[h].viewportMaximum); w++) r[w].endValue < q[h].viewportMinimum || (s(q[h].scaleBreaks.firstBreakIndex) && (q[h].scaleBreaks.firstBreakIndex = w), r[w].startValue >= q[h].viewPortMinimum && (q[h].scaleBreaks.lastBreakIndex = w));
            ...
            if ("normal" === e) {
                ...
                w;) {
                    ...
                    if (c && 0 < c.length) for (y = [], h = O = 0; h < c.length; h++) y.push(Math.ceil(c[h] ? c[h].createLabelsAndCalculateWidth() : 0)), O += y[h], L += c[h] && !m.isNavigator ? c[h].margin : 0; else y.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    P.push(y);
                    if (b && 0 < b.length) for (D = [], h = $ = 0; h < b.length; h++) D.push(Math.ceil(b[h] ? b[h].createLabelsAndCalculateWidth() : 0)), $ += D[h], Z += b[h] ? b[h].margin : 0; else D.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                    R.push(D);
                    p = Math.round(f.x1 + O + L);
                    l = Math.round(f.x2 - $ - Z > m.width - n ? m.width - n : f.x2 - $ - Z);
                    if (a && 0 < a.length) for (x = [], h = T = 0; h < a.length; h++) a[h] && (a[h].lineCoordinates = {}), a[h].lineCoordinates.width = Math.abs(l - p), a[h].title && (a[h]._titleTextBlock.maxWidth = 0 < a[h].titleMaxWidth && a[h].titleMaxWidth < a[h].lineCoordinates.width ? a[h].titleMaxWidth : a[h].lineCoordinates.width), x.push(Math.ceil(a[h] ? a[h].createLabelsAndCalculateHeight() : 0)), T += x[h], e += a[h] && !m.isNavigator ? a[h].margin : 0; else x.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() :
                        0));
                    M.push(x);
                    if (d && 0 < d.length) for (A = [], h = V = 0; h < d.length; h++) d[h] && (d[h].lineCoordinates = {}), d[h].lineCoordinates.width = Math.abs(l - p), d[h].title && (d[h]._titleTextBlock.maxWidth = 0 < d[h].titleMaxWidth && d[h].titleMaxWidth < d[h].lineCoordinates.width ? d[h].titleMaxWidth : d[h].lineCoordinates.width), A.push(Math.ceil(d[h] ? d[h].createLabelsAndCalculateHeight() : 0)), V += A[h], W += d[h] && !m.isNavigator ? d[h].margin : 0; else A.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                    N.push(A);
                    ...
                    if (d && 0 < d.length) for (h = 0; h < d.length; h++) d[h].lineCoordinates.x1 = Math.round(f.x1 + O + L), d[h].lineCoordinates.x2 =
                    ...
                    if (c && 0 < c.length) for (h = 0; h < c.length; h++) L = m.isNavigator ? 0 : 10, c[h] && (p = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[c[h]._labels.length - 1].textBlock.height / 2 : n, g = Math.round(f.y1 + V + W < Math.max(L, n) ? Math.max(L, n) : f.y1 + V + W), l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = 0 < a.length ? 0 : c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[0].textBlock.height /
                    ...
                    if (b && 0 < b.length) for (h = 0; h < b.length; h++) b[h] && (p = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), l = Math.round(p), L = b[h]._labels && 0 < b[h]._labels.length ? b[h]._labels[b[h]._labels.length - 1].textBlock.height / 2 : 0, g = Math.round(f.y1 + V + W < Math.max(L, n) ? Math.max(L, n) : f.y1 + V + W), L = 0 < a.length ? 0 : b[h]._labels && 0 < b[h]._labels.length ? b[h]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (T + e + L)), b[h].lineCoordinates =
                        {
                            x1: p + X,
                            y1: g,
                            x2: p + X,
                    ...
                    if (d && 0 < d.length) for (h = 0; h < d.length; h++) d[h].calculateValueToPixelConversionParameters(), d[h].calculateBreaksSizeInValues(), d[h]._labels && 1 < d[h]._labels.length && (z = (d[h].logarithmic ?
                    ...
                    if (0 < w) {
                        if (a && 0 < a.length) for (h = 0; h < a.length; h++) r = M[w - 1][h] === M[w][h] ? !0 : !1; else r = !0;
                        if (d && 0 < d.length) for (h = 0; h < d.length; h++) H = N[w - 1][h] === N[w][h] ? !0 : !1; else H = !0;
                        if (c && 0 < c.length) for (h = 0; h < c.length; h++) J = P[w - 1][h] === P[w][h] ? !0 : !1; else J = !0;
                        if (b && 0 < b.length) for (h = 0; h < b.length; h++) K = R[w -
                ...
                for (N = []; 4 > w;) {
                    ...
                    if (a && 0 < a.length) for (F = [], h = X = 0; h < a.length; h++) F.push(Math.ceil(a[h] ? a[h].createLabelsAndCalculateWidth() : 0)), X += F[h], e += a[h] && !m.isNavigator ? a[h].margin : 0; else F.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    M.push(F);
                    if (d && 0 < d.length) for (v = [], h = T = 0; h < d.length; h++) v.push(Math.ceil(d[h] ? d[h].createLabelsAndCalculateWidth() : 0)), T += v[h], W += d[h] ? d[h].margin : 0; else v.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() :
                        0));
                    N.push(v);
                    if (c && 0 < c.length) for (h = 0; h < c.length; h++) c[h].lineCoordinates = {}, p = Math.round(f.x1 + X + e), l = Math.round(f.x2 - T - W > m.width - 10 ? m.width - 10 : f.x2 - T - W), c[h].labelAutoFit && !s(x) && (0 < !a.length && (p = 0 > c[h].labelAngle ? Math.max(p, x) : 0 === c[h].labelAngle ? Math.max(p, x / 2) : p), 0 < !d.length && (l = 0 < c[h].labelAngle ? l - A / 2 : 0 === c[h].labelAngle ? l - A / 2 : l)), c[h].lineCoordinates.x1 = p, c[h].lineCoordinates.x2 = l, c[h].lineCoordinates.width = Math.abs(l - p), c[h].title && (c[h]._titleTextBlock.maxWidth = 0 < c[h].titleMaxWidth && c[h].titleMaxWidth <
                    c[h].lineCoordinates.width ? c[h].titleMaxWidth : c[h].lineCoordinates.width);
                    if (b && 0 < b.length) for (h = 0; h < b.length; h++) b[h].lineCoordinates = {}, p = Math.round(f.x1 + X + e), l = Math.round(f.x2 - T - W > b[h].chart.width - 10 ? b[h].chart.width - 10 : f.x2 - T - W), b[h] && b[h].labelAutoFit && !s(y) && (0 < !a.length && (p = 0 < b[h].labelAngle ? Math.max(p, y) : 0 === b[h].labelAngle ? Math.max(p, y / 2) : p), 0 < !d.length && (l -= D / 2)), b[h].lineCoordinates.x1 = p, b[h].lineCoordinates.x2 = l, b[h].lineCoordinates.width = Math.abs(l - p), b[h].title && (b[h]._titleTextBlock.maxWidth =
                        0 < b[h].titleMaxWidth && b[h].titleMaxWidth < b[h].lineCoordinates.width ? b[h].titleMaxWidth : b[h].lineCoordinates.width);
                    if (c && 0 < c.length) for (n = [], h = U = 0; h < c.length; h++) n.push(Math.ceil(c[h] ? c[h].createLabelsAndCalculateHeight() : 0)), U += n[h] + c[h].margin, L += c[h].margin; else n.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    E.push(n);
                    if (b && 0 < b.length) for (z = [], h = S = 0; h < b.length; h++) z.push(Math.ceil(b[h] ? b[h].createLabelsAndCalculateHeight() : 0)), S += z[h], Z += b[h].margin; else z.push(Math.ceil(b[0] ?
                        b[0].createLabelsAndCalculateHeight() : 0));
                    u.push(z);
                    if (c && 0 < c.length) for (h = 0; h < c.length; h++) 0 < c[h]._labels.length && (k = c[h]._labels[0], g = c[h]._labels[c[h]._labels.length - 1], x = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - g.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), A = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) + (g.textBlock.height - g.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(g.textBlock.angle)));
                    ...
                    if (m.panEnabled) for (h = 0; h < c.length; h++) n[h] = s(m.sessionVariables.axisY.height) ?
                        m.sessionVariables.axisY.height = n[h] : m.sessionVariables.axisY.height; else for (h = 0; h < c.length; h++) m.sessionVariables.axisY.height = n[h];
                    if (c && 0 < c.length) for (h = c.length - 1; 0 <= h; h--) g = Math.round(f.y2), k = Math.round(f.y2 > c[h].chart.height ? c[h].chart.height : f.y2), c[h].lineCoordinates.y1 = g - (n[h] + c[h].margin + V), c[h].lineCoordinates.y2 = g - (n[h] + c[h].margin + V), "inside" === c[h].labelPlacement && 0 < h && (c[h].lineCoordinates.y1 = c[h].lineCoordinates.y1 + n[h] - (c[h]._titleTextBlock ? c[h]._titleTextBlock.height : 0) - ("inside" ===
                    ...
                    if (b && 0 < b.length) for (h = b.length - 1; 0 <= h; h--) b[h] && (g = Math.round(f.y1), k = Math.round(f.y1 + (z[h] + b[h].margin + G)), b[h].lineCoordinates.y1 =
                    ...
                    if (a && 0 < a.length) for (h = 0; h < a.length; h++) {
                        ...
                        if (c && 0 < c.length) for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (l = 0 > c[L].labelAngle ? Math.max(l, x) : 0 === c[L].labelAngle ? Math.max(l, x / 2) : l, p =
                            0 > c[L].labelAngle || 0 === c[L].labelAngle ? l - X : p);
                        if (b && 0 < b.length) for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && (l = b[L].lineCoordinates.x1, p = l - X);
                    ...
                    if (d && 0 < d.length) for (h = 0; h < d.length; h++) {
                        ...
                        k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2 - U) : f.y2 > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2;
                        if (c && 0 < c.length) for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (l = 0 > c[L].labelAngle ? Math.max(l, x) : 0 === c[L].labelAngle ? Math.max(l, x / 2) : l, p = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? l - T : p);
                    ...
                    if (0 < w) {
                        if (a && 0 < a.length) for (h = 0; h < a.length; h++) r = M[w - 1][h] === M[w][h] ? !0 : !1; else r = !0;
                        if (d && 0 < d.length) for (h = 0; h < d.length; h++) H = N[w - 1][h] === N[w][h] ? !0 :
                            !1; else H = !0;
                        if (c && 0 < c.length) for (h = 0; h < c.length; h++) J = E[w - 1][h] === E[w][h] ? !0 : !1; else J = !0;
                        if (b && 0 < b.length) for (h = 0; h < b.length; h++) K = u[w - 1][h] === u[w][h] ? !0 : !1; else K = !0
                    }
                    if (r && H && J && K) break;
                    w++
                }
        ...
        E.render = function (a, d, c, b, e) {
            ...
            e.restore();
            if (a && 0 < a.length) for (g = 0; g < a.length; g++) a[g].renderGrid(),
        ...
        E.prototype.renderLabelsTicksAndTitle = function () {
            ...
            }, this); else for (k = 0; k < this._labels.length; k++) n = this._labels[k], n.position < this.viewportMinimum || (n.position > this.viewportMaximum || d && 0 !== f++ % 2 && this.labelAutoFit) || n.textBlock.render(!0)
        };
        ...
        E.prototype.renderAxisLine = function () {
            ...
            if ("bottom" === this._position || "top" === this._position) {
                if (this.lineThickness) {
                    ...
                    d.beginPath();
                    if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex)) if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b; else for (var l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++) d.moveTo(e,
                ...
                d.beginPath();
                if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex)) if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c; else for (l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++) d.moveTo(g, e), d.lineTo(g, this.scaleBreaks._appliedBreaks[l].startPixel + b), e = this.scaleBreaks._appliedBreaks[l].endPixel + c;
        ...
        E.prototype.calculateAxisParameters = function () {
            if (this.logarithmic) this.calculateLogarithmicAxisParameters(); else {
                ...
                var a = Math.max(b, Math.floor(this.maxWidth / a)), e, f, g, b = 0;
        ...
        T.prototype.render = function (a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position) if (b = 1 === n % 2 ? (b.x << 0) + 0.5 : b.x << 0, g = 1 === n % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 + n / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = {
                    x1: b - n / 2,
                    y1: e,
                    x2: g + n / 2,
                    y2: l
                }, this.ctx.moveTo(b,
                    e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, l), this.ctx.lineTo(g, l), this.ctx.lineTo(g, e); else if ("wavy" === this.type) {
                    s = b;
                    k = e;
                    f = 0.5;
                    m = (l - k) / a / 3;
                    ...
                    x2: g,
                    y2: l + n / 2
                }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(g, e), this.ctx.lineTo(g, l), this.ctx.lineTo(b, l); else if ("wavy" === this.type) {
                    s = b;
                    k = e;
                    f = 0.5;
                    m = (g - s) / a / 3;
        ...
        $.prototype.render = function (a, d, c) {
            var b, e, f, g, l = null, w = null, k = null, m = "";
            ...
            var k = null === this.opacity ? 1 : this.opacity,
                ...
                q = this.chart.overlaidCanvasCtx, h = q.globalAlpha;
            q.globalAlpha = k;
            q.beginPath();
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var v = null;
                    if ("bottom" === this.parent._position || "top" === this.parent._position) r = this.parent.dataSeries[0].axisX.convertPixelToValue({y: d}); else if ("left" ===
                    ...
                    u < v && (v = u, y = r); else u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y)), u < v && (v = u, y = r);
                    x = m[y];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        C = !1;
                        if (this.parent.labels) for (m = Math.ceil(this.parent.interval), r = 0; r < this.parent.viewportMaximum; r += m) if (this.parent.labels[r]) C = !0; else {
                            C = !1;
                            break
                        }
                        if (C) {
                    ...
                    if (C) {
                        if ("axisX" === this.parent.type) for (r =
                                                                   this.parent.convertPixelToValue({x: a}), v = null, y = 0; y < this.parent.dataSeries.length; y++) (v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: x.dataPoint.x
                    ...
                    y = 0;
                    if ("rangeColumn" === m[0].dataSeries.type || "rangeArea" === m[0].dataSeries.type || "error" === m[0].dataSeries.type || "rangeSplineArea" === m[0].dataSeries.type || "candlestick" === m[0].dataSeries.type || "ohlc" === m[0].dataSeries.type || "boxAndWhisker" === m[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y[0])),
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" === this.parent._position || "right" === this.parent._position) {
                    ...
                    if (this.parent.labels) for (m = Math.ceil(this.parent.interval),
                                                     r = 0; r < this.parent.viewportMaximum; r += m) if (this.parent.labels[r]) C = !0; else {
                        C = !1;
                        break
                    }
                    if (C) {
                        if ("axisX" === this.parent.type) for (r = this.parent.convertPixelToValue({x: a}), v = null, y = 0; y < this.parent.dataSeries.length; y++) (v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: c ? c : this.parent.convertPixelToValue(a)
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        l = [];
                        if (this.chart.axisX) for (v = 0; v < this.chart.axisX.length; v++) for (g = this.chart.axisX[v].convertPixelToValue({x: a}), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++) (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(g, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && l.push(k));
                        if (this.chart.axisX2) for (v = 0; v < this.chart.axisX2.length; v++) for (g = this.chart.axisX2[v].convertPixelToValue({x: a}), k = null, b = 0; b < this.chart.axisX2[v].dataSeries.length; b++) (k =
        ...
        W.prototype.getToolTipInnerHTML = function (a) {
            a = a.entries;
            for (var d = null, c = null, b = null, e = 0, f = "", g = !0, l = 0; l < a.length; l++) if (a[l].dataSeries.toolTipContent ||
        ...
        W.prototype.showAtX = function (a, d) {
            ...
            if (this.shared) for (var g = 0; g < this.chart.data.length; g++) c = this.chart.data[g], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !s(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b)); else c = this.chart.data[d], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !s(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b));
            if (0 < f.length) {
